<template>
    <div class="relative flex h-screen min-w-screen">
        <!-- Sidebar -->
        <div class="overflow-hidden bg-gradient-to-b from-blue-500 to-pink-500 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform -translate-x-full transition duration-200 ease-in-out"
            ...
            <div @click="clickUserManagement('user')"
                class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-500 text-white">
                <i class="bi bi-house-door-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200 font-bold">Quản lý người dùng</span>
            </div>
            <transition name="fade">
                <div v-if="showOrderDropdown">
                    <div @click="clickCustomer()"
                        class="p-2.5 mt-3 flex items-center  ml-5 rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-500 text-white">
            ...
            <div @click=""
                class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-500 text-white">
                <i class="bi bi-house-door-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200 font-bold">Quản lý bài viết</span>
            </div>
            <div class="my-2 bg-gray-600 h-[0.5px]"></div>
            <div @click="logOut()"
                class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-500 text-white">
        ...
        <div class="flex-1 overflow-hidden">
            ...
            <div class="grid justify-items-stretch bg-white shadow px-2 py-4">
                <div class="flex justify-between">
                    ...
                    <div class="font-bold text-4xl animate-gradient py-2">TRANG QUẢN TRỊ HỆ THỐNG
                    </div>
                    <div></div>
                </div>
            </div>
...
.animate-gradient {
    background-image: linear-gradient(to right, #10c43a, #0572e6, #f1de32);
    /* Đổi màu xanh lá cây vào đây */
